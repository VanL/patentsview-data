...
CREATE TABLE "claim" (
  ...
  PRIMARY KEY ("uuid"),
  KEY "ix_claim_patent_id" ("patent_id")
);
...
CREATE TABLE "location" (
  ...
  KEY "location_county" ("county"),
  KEY "location_state_fips" ("state_fips"),
  KEY "location_county_fips" ("county_fips")
);
...
CREATE TABLE "rawassignee" (
  ...
  KEY "ix_organization" ("organization"(255))
);
...
CREATE TABLE "rawlawyer" (
  ...
  "sequence" int(11) DEFAULT NULL,
  PRIMARY KEY ("uuid"),
  KEY "ix_rawlawyer_patent_id" ("patent_id"),
